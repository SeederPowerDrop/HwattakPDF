...
현재 공개 배포 문서 기준은 **HwattakPDF 0.8.0 (build 18)**입니다. 다음 릴리스용 소스 트리의 이미지·HTML 기반 PDF 만들기와 Word/PowerPoint 내보내기는 공개 0.8.0 태그·ZIP에 없는 미출시 변경이며, 구현·검증·남은 수동 확인은 개발노트의 날짜별 기록에서 구분합니다. 뷰어·에디팅·학습 모드의 사용자 범위는 제품 정의, capability·PDFKit 저장 한계·schema 2 앱 소유 웹 패널의 신뢰 경계는 아키텍처에서 확인할 수 있습니다.
...
| [개발노트](DEVELOPMENT-LOG.md) | 사용자·기여자 | 시작 동기부터 0.7.0 재구성 기록, 이후 공개 릴리스와 미출시 개발 트리의 문제·변경·검증·한계 |
...
| [품질 점검 보고서](QUALITY_REPORT.md) | 공개 0.8.0 commit·배포 ZIP의 고정 자동 검증 기준선, 알려진 위험과 수동 확인 필요 항목 |
