...
///
/// `HwattakPDFApp` owns scene registration, so this file deliberately exposes a
...
/// A reusable command set for `HwattakPDFApp.commands`.
...
struct HelpTutorialView: View {
    ...
    private func tutorialEntry(_ entry: HelpTutorialEntry) -> some View {
        ...
        .padding(15)
        .frame(maxWidth: .infinity, alignment: .leading)
        .hwattakPDFCard(theme, cornerRadius: 12)
