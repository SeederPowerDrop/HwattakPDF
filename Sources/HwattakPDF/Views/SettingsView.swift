    ...
    private var appearanceSection: some View {
        settingsCard {
            VStack(alignment: .leading, spacing: 16) {
                sectionHeader(
                    title: L10n.string("appearance.title"),
                    description: L10n.string("settings.appearance.description"),
                ...
                .accessibilityLabel(L10n.string("appearance.title"))
            }
        }
    }
            ...
            VStack(alignment: .leading, spacing: 16) {
                sectionHeader(
                    ...
                    description: L10n.string(
                        ...
                        defaultValue: "메인 PDF 화면의 키보드, 마우스와 트랙패드 조작을 설정합니다."
                    ),
                    systemImage: "cursorarrow.motionlines"
                )

                Picker(
                    L10n.string("pdf.navigation.label"),
                    selection: $pageNavigationModeValue
                ) {
                ...
                Text(L10n.string("pdf.navigation.help"))
                    .font(.caption)
                    .foregroundStyle(theme.secondaryText)
                    .fixedSize(horizontal: false, vertical: true)
                ...
                if pageNavigationModeValue != PDFPageNavigationMode.horizontalPaging.rawValue {
                    Label(
                        L10n.string(
