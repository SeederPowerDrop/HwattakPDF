...
struct AboutView: View {
    ...
    var body: some View {
        ...
        .background(Color(red: 0.95, green: 0.94, blue: 0.86))
        .overlay {
            Rectangle()
                .stroke(Color(red: 0.35, green: 0.36, blue: 0.37), lineWidth: 2)
        }
        // The light beige palette is deliberate: this window recreates an
        // early-2000s desktop dialog even when the rest of macOS uses Dark Mode.
    ...
    private var supportCard: some View {
        VStack(alignment: .leading, spacing: 11) {
            Label(AboutContent.supportTitle, systemImage: "heart.fill")
                ...
                .foregroundStyle(Color(red: 0.42, green: 0.08, blue: 0.04))
        ...
        .overlay {
            RoundedRectangle(cornerRadius: 8)
                .stroke(Color(red: 0.42, green: 0.34, blue: 0.12), lineWidth: 2)
        }
    ...
    private var githubRow: some View {
        if let githubURL = AboutContent.githubURL {
            ...
            .font(.system(size: 15.5, weight: .medium))
            .foregroundStyle(Color(red: 0.0, green: 0.25, blue: 0.92))
            .underline()
    ...
    private var bottomBar: some View {
        VStack(spacing: 0) {
            Rectangle()
                .fill(Color(red: 0.53, green: 0.53, blue: 0.55))
                .frame(height: 1)
...
private struct ClassicWindowsButtonStyle: ButtonStyle {
    func makeBody(configuration: Configuration) -> some View {
        configuration.label
            ...
            .overlay {
                RoundedRectangle(cornerRadius: 8)
                    .stroke(Color(red: 0.54, green: 0.54, blue: 0.57), lineWidth: 2)
                    .padding(2)
            }
            .clipShape(RoundedRectangle(cornerRadius: 8))
            .shadow(color: .black.opacity(0.45), radius: 0, x: 3, y: 4)
