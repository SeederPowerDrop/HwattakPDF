...
private struct StudyMarkupSettingsPopover: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            ColorPicker(
                L10n.string("study.markup.color", defaultValue: "색상"),
            ...
            valueSlider(
                ...
                range: Double(StudyMarkupStyle.thicknessRange.lowerBound)...Double(StudyMarkupStyle.thicknessRange.upperBound),
