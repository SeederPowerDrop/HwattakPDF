...
final class PDFTabGroupTests: XCTestCase {
    ...
    func testTabStripInstallsAPassiveVerticalWheelMonitor() throws {
        ...
        let tabBarSource = try String(
            contentsOf: root.appendingPathComponent("Sources/HwattakPDF/Views/PDFTabBar.swift"),
            encoding: .utf8
        )
        let monitorSource = try String(
            contentsOf: root.appendingPathComponent(
                "Sources/HwattakPDF/Views/PDFTabStripWheelMonitor.swift"
            ),
            encoding: .utf8
        )
    ...
    private func makePDFFixture(names: [String]) throws -> (directory: URL, urls: [URL]) {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("HwattakPDF-Tab-Tear-Out-Tests-\(UUID().uuidString)", isDirectory: true)
