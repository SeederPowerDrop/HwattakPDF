...
final class SearchNavigatorPresentationTests: XCTestCase {
    ...
    func testWorkspacePassesSearchMinimumIntoEveryResizePath() throws {
        let workspaceSource = try source("Sources/HwattakPDF/Views/WorkspaceView.swift")
    ...
    func testFindCommandIsScopedToAnAvailableFocusedDocumentScene() throws {
        let appSource = try source("Sources/HwattakPDF/App/HwattakPDFApp.swift")
        let tabSource = try source("Sources/HwattakPDF/Views/TabbedWorkspaceView.swift")
        let toolbarSource = try source("Sources/HwattakPDF/Views/WorkspaceToolbar.swift")
    ...
    func testLargeResultRowsUseLazyStacksAndCachedOrdinals() throws {
        let navigatorSource = try source(
            "Sources/HwattakPDF/Views/SearchNavigatorSidebarView.swift"
        )
        let pageSidebarSource = try source("Sources/HwattakPDF/Views/PageSidebarView.swift")
